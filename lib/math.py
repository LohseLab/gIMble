...
class EquationSystemObj(object):
    ...
    def calculate_all_ETPs(self):
        ...
        for rates, split_time in zip(self.rate_by_variable, self.split_times):
            ...
            self.ETPs.append(self.calculate_ETPs(rates=rates, split_time=split_time))
        """
    ...
    def infer_composite_likelihood(self, bSFS_counts):
        ETPs=self.calculate_ETPs(rates, split_time, verbose=False)
        return calculate_composite_likelihood(ETPs, data)
