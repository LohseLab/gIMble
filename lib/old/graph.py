...
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.E.paths.txt -t 4 -A 1.0 -D 1.0 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.M+E.paths.txt -t 4 -A 1.0 -D 1.0 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.M+R.paths.txt -t 4 -A 1.0 -D 1.0 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.M.paths.txt -t 4 -A 1.0 -D 1.0 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.R.paths.txt -t 4 -A 1.0 -D 1.0 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.E.paths.txt -t 4 -A 1.0 -D 1.3 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.M+E.paths.txt -t 4 -A 1.0 -D 1.3 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.M+R.paths.txt -t 4 -A 1.0 -D 1.3 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.M.paths.txt -t 4 -A 1.0 -D 1.3 -M 2.34 -m 1.2 -T 1.4 -P 30 ; \
python2 src/probs.py probs -p output/master.2_samples.2_pop.2_ploidy.R.paths.txt -t 4 -A 1.0 -D 1.3 -M 2.34 -m 1.2 -T 1.4 -P 30 
...
def plot_state_graph(state_graph=state_graph, out_f=out_f, parameterObj=parameterObj, mutypes_flag=False, no_graph_labels=False):
...
def get_state_paths(state_graph, sampleStateObj, parameterObj):
    '''
    ...
    #event_map = {'C_resident' : 'C_derived', 'C_migrant' : 'C_ancestor', 'M': 'M', 'E': 'E'}
    event_map = {'C_resident' : 'C_ancestor', 'C_migrant' : 'C_derived', 'M': 'M', 'E': 'E'}
    #C_ancestor = 'C_migrant'
    C_ancestor = 'C_resident'
    #C_derived = 'C_resident'
    C_derived = 'C_migrant'
    if parameterObj.reverse_exodus: 
        # event_map = {'C_resident' : 'C_ancestor', 'C_migrant' : 'C_derived', 'M': 'M', 'E': 'E'}
        event_map = {'C_resident' : 'C_derived', 'C_migrant' : 'C_ancestor', 'M': 'M', 'E': 'E'}
    ...
    for path_idx, path in enumerate(nx.all_simple_paths(state_graph, source=node_idx_by_meta['source'], target=node_idx_by_meta['sink'])):
        ...
        for source, sink in pairwise(path):
            ...
            line.append(source)
            line.append(event_map[state_graph[source][sink]['event']])
...
class ParameterObj(object):
    ...
    def plot_graph(self, state_graph, parameterObj):
        ...
        plot_state_graph(state_graph=state_graph, out_f=out_f, parameterObj=parameterObj, mutypes_flag=self.plot_mutypes, no_graph_labels=self.no_graph_labels)
...
def main():
    try:
        ...
        header, paths = get_state_paths(state_graph, sampleStateObj, parameterObj)
