...
"""usage: gimbl parse                -v FILE -b FILE -g FILE -s FILE [-o STR -f -D -h]
    ...
    [Options]
        ...
        -s, --sample_f FILE          Gimble sample file (CSV) (for filtering VCF file vertically). Only two populations supported.
        -v, --vcf_f FILE             VCF file of variants. bgzip'ed. Indexed.
        -o, --outprefix STR          Prefix to use in output files [default: gimble]
        -f, --force                  Force overwriting existing GimbleStore.
...
import src.gimble.gimble 

class SetupParameterObj(src.gimble.gimble.ParameterObj):
...
def main(params):
    try:
        ...
        gimbleStore = src.gimble.gimble.Store(prefix=parameterObj.outprefix, create=True, overwrite=parameterObj.overwrite)
